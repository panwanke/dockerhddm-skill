# tutorial gonogo chisquare

> Converted from `hddm/hddm/examples/tutorial_gonogo_chisquare.ipynb`. Code is preserved; rich outputs are omitted.

## Fit go/no-go using the chi-qsuare approach
### by Jan Willem de Gee (<EMAIL>)
